            ...
            <div className="relative container mx-auto px-3">
                <div className="relative flex flex-col items-center py-14">
                    ...
                    <div className="flex flex-wrap justify-center items-center space-x-2 md:space-x-10 mb-12">
                        <div className="flex flex-col justify-between items-center min-h-auto  md:min-h-[180px] min-w-auto md:min-w-[200px] py-5 px-8 rounded-xl text-[#C1C1CA] bg-[#F5F5F7]">
