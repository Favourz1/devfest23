            ...
            <div className="relative container mx-auto px-3">
                <div className="relative flex flex-col items-center py-14">
                    ...
                    <div className="hidden md:flex justify-center items-center space-x-10 mb-12">
                        ...
                        <div className="flex flex-col justify-between items-center min-h-[180px] min-w-[200px] py-5 px-8 rounded-xl text-[#C1C1CA] bg-[#F5F5F7]">
                            <div className="text-8xl font-bold">{timeLeft.hours.toString().padStart(2, '0')}</div>
                            <div className="text-2xl">hours</div>
                        </div>
                        <div className="flex flex-col justify-between items-center min-h-[180px] min-w-[200px] py-5 px-8 rounded-xl text-[#C1C1CA] bg-[#F5F5F7]">
                            <div className="text-8xl font-bold">{timeLeft.minutes.toString().padStart(2, '0')}</div>
                            <div className="text-2xl">minutes</div>
                        </div>
                        <div className="flex flex-col justify-between items-center min-h-[180px] min-w-[200px] py-5 px-8 rounded-xl text-[#C1C1CA] bg-[#F5F5F7]">
                            <div className="text-8xl font-bold">{timeLeft.seconds.toString().padStart(2, '0')}</div>
